...
public class DontLook {
    ...
    public DontLook(ConcertRepo concertRepo, ConcertFinderRepo concertFinderRepo, Clock clock) {
    ...
    public DontLook withTitle(String title) {
        builder.title(Title.from(title).get());
        return this;
    }

    public DontLook withDate(Instant date) {
        builder.date(ConcertDate.from(date.toString(), clock).get());
        return this;
    }

    public DontLook withVendorId(String vendorId) {
